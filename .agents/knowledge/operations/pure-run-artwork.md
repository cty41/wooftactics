...
timestamp: "2026-09-14T16:59:05+08:00"
status: active
...
source_fingerprint: sha256:c8a5096f187f3928b4a2f033bc7823f17ae701af39219499bad785aa40cfff89
---
...
- 诗人动作试点已闭合 Melee/Cast/Hit 的 DR/UL 与通用 Death 离线晋升，并沉淀“Visual Moment → 纯橙火柴人 Pose Proof → 来源职责 → 单张候选 → 完整上下文 → promotion/runtime 分离批准”的低成本动作流程。Pose sketch 只决定时点、力线、重心、接触、负形与剪影；身份、装备形制和精确几何分别由正式母图、装备锚点与 Composition/Pose Guide 承担。未选草图不进入 Attempt/Series，ImageGen 每张暂停，连续两轮同类语义失败或可确定性 Assembly 时换策略。
